...
class ChannelView(View):
    template_name = "youtube/channelview.html"
...
def liked_videos(request):
    ...
    return render(request, "youtube/liked_videos.html", context)
...
def watch_history(request):
    ...
    return render(request, "youtube/watch_history.html", context)
...
def help(request):
    return render(request, "youtube/aboutUs.html", {})
...
def channels_list(request):
    ...
    return render(request, 'youtube/channels_list.html', context)
